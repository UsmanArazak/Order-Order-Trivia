...
const KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || ''; // Read secret key from env to avoid security blocks
...
async function seed() {
  ...
  try {
    ...
    console.log('Seeding initial questions using secret key...');
